...
export const LowIntensityIcon = ({
  color = '#FFFFFF',
  width = 28.938,
  height = 22.976,
}) => {
  const xml = `
    <svg id="Groupe_370" data-name="Groupe 370" xmlns="http://www.w3.org/2000/svg" width=${width} height=${height} viewBox="0 0 28.938 22.976">
      ...
      <g id="Groupe_295" data-name="Groupe 295" transform="translate(4.738 6.022)">
        ...
        <path id="Tracé_386" data-name="Tracé 386" d="M73.16,109.7a.949.949,0,0,0-.013.926L74.54,113.2a8.47,8.47,0,1,0,2.34-4.053l-2.925.081A.948.948,0,0,0,73.16,109.7Zm3.3,3.655a6.576,6.576,0,1,1,3.012,7.581A6.575,6.575,0,0,1,76.463,113.359Z" transform="translate(-73.033 -106.767)" fill=${color}/>
      </g>
      <path id="Tracé_387" data-name="Tracé 387" d="M99.25,60.633l.95,1.646a12.4,12.4,0,0,1,5.429-1.25,12.715,12.715,0,0,1,5.5,1.252l.951-1.645a14.474,14.474,0,0,0-12.828,0Z" transform="translate(-91.197 -59.138)" fill=${color} opacity="0.3"/>
...
export default LowIntensityIcon;
