...
export const HardIntensityIcon = ({
  color = '#FFFFFF',
  width = 28.938,
  height = 22.976,
}) => {
  const xml = `
    <svg id="Groupe_370" data-name="Groupe 370" xmlns="http://www.w3.org/2000/svg" width=${width} height=${height} viewBox="0 0 28.938 26.618">
      ...
      <g id="Groupe_295" data-name="Groupe 295" transform="translate(4.738 6.022)">
        ...
        <path id="Tracé_386" data-name="Tracé 386" d="M73.16,109.7a.949.949,0,0,0-.013.926L74.54,113.2a8.47,8.47,0,1,0,2.34-4.053l-2.925.081A.948.948,0,0,0,73.16,109.7Zm3.3,3.655a6.576,6.576,0,1,1,3.012,7.581A6.575,6.575,0,0,1,76.463,113.359Z" transform="translate(149.969 -5.029) rotate(120)" fill=${color}/>
      </g>
      ...
      <path id="Tracé_388" data-name="Tracé 388" d="M212.978,86.358a14.452,14.452,0,0,0-5.837-7.892l-.951,1.646a12.348,12.348,0,0,1,2.07,1.764,12.662,12.662,0,0,1,2.9,5.027,12.44,12.44,0,0,1,.493,2.674h1.9A14.232,14.232,0,0,0,212.978,86.358Z" transform="translate(-184.616 -76.022)" fill=${color}/>
    </svg>
    `;
...
export default HardIntensityIcon;
